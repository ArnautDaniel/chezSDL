...
(define *window* (sdl-create-window "Lesson 5"
				    0 0 ;;; x, y
				    *screen-w*
				    *screen-h*
				    0))
...
(define nimg (sdl-convert-surface (img-load "loaded.png")
				  (get-surface-format *surface*) 0))
...
(sdl-upper-blit-scaled
 nimg
 (make-rect 0 0 (surface-width nimg)
	    (surface-height nimg))
 *surface*
